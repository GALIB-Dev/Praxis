  ...
  return (
    <div className="min-h-screen bg-[#F7F9F4] overflow-hidden relative">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-4 sm:py-6">
        {/* Header */}
        <div className="mb-5 bg-white/50 backdrop-blur-xl rounded-lg p-4 border border-[#A3B18A]00/50">
          <div className="flex items-center gap-3 mb-4">
            <Icon name="business-svgrepo-com" size={32} color="#3A7D44" />
            <h1 className="text-2xl font-bold text-white">Job Matches</h1>
          </div>
          <p className="text-sm text-[#344E41]/8000">Based on your verified skills, here are the best opportunities</p>
          <p className="text-xs text-[#344E41]/6000 mt-1">Found {jobs.length} matching positions</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 space-y-3">
            {jobs.map((job) => (
              <div
                ...
                className={`bg-white/30 border transition-all duration-200 cursor-pointer rounded-lg p-6 backdrop-blur-sm ${
                  selectedJob?.id === job.id
                    ? "border-[#A3B18A]00 shadow-lg shadow-blue-500/20"
                    : "border-[#A3B18A]00/50 hover:border-slate-600/80"
                }`}
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start gap-3 flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-[#344E41]/6000 mt-1">{job.company}</p>
                    </div>
                  </div>
                  <div
                ...
                <div className="flex flex-wrap gap-3 mb-4 text-sm text-[#344E41]/8000">
                  ...
                  <span className="inline-block px-2 py-1 bg-[#A3B18A]/10 text-[#3A7D44]00 rounded text-xs font-semibold border border-[#A3B18A]00/50">
                    {job.type}
                  </span>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {job.skills.map((skill) => (
                    <span
                      key={skill}
                      className="inline-block px-2 py-1 bg-slate-700/50 text-[#344E41]/8000 rounded text-xs font-medium border border-slate-600/50"
                    >
                      {skill}
                    </span>
                  ))}
          ...
          <div className="lg:col-span-1">
            {selectedJob ? (
              <div className={`bg-white/30 rounded-lg p-6 border border-[#A3B18A]00/50 sticky top-4 space-y-4 transition-transform duration-300 backdrop-blur-sm ${
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#344E41]/6000 mt-1">{selectedJob.company}</p>
                    </div>
                  </div>
                </div>

                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-2 text-[#344E41]/8000">
                ...
                <div className="pt-4 border-t border-[#A3B18A]00/50">
                  <p className="text-sm font-semibold text-white mb-2">About this role</p>
                  <p className="text-sm text-[#344E41]/6000">{selectedJob.description}</p>
                </div>

                <div className="pt-4 border-t border-[#A3B18A]00/50">
                  <p className="text-sm font-semibold text-white mb-3">Your Skills Match</p>
                  <div className="space-y-2">
                    {selectedJob.skills.map((skill) => (
                      <div key={skill} className="flex items-center gap-2">
                        <Icon name="check-circle-svgrepo-com" size={16} color="#10B981" />
                        <span className="text-sm text-[#344E41]/8000">{skill}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-2 px-4 rounded-lg font-semibold text-[#344E41]/8000 hover:text-white border border-slate-600/50 hover:border-slate-500 transition-all"
                >
                  Back to Skills
                </button>
              </div>
              ...
              <div className="bg-slate-100 rounded-lg p-6 border border-slate-200 text-center">
                ...
                <p className="text-slate-600 font-medium">Select a job to view details</p>
              </div>
            )}
          </div>
        </div>
